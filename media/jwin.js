          ...
          if(this.background != ''){
	         ...
	         return '<table' + this.getPopW() + this.getPopH() + ' border="0" cellpadding="0" cellspacing="0" background="' + jw_bgpic + '"><tr><td>' + this.getPaddedText(this.writetext) + '</td></tr></table>'
               ...
               if(this.classes){
                    ...
                    //Peter: border fix for Firefox
                    return '<table' + this.getPopW() + this.getPopH() + ' style="border-style: solid; border-width: 2px;" bordercolor="' + this.bordercolor + '" cellpadding="' + this.bordercellpadding + '" cellspacing="' + this.bordercellspacing + '" bgcolor="' + this.bgcolor + '"><tr><td>' + this.getPaddedText(this.writetext) + '</td></tr></table>'
               }
          }
     }
}
...
function jw_getCaptionPopup(){
     ...
     if(this.classes){
          ...
          //Peter: border fix for Firefox
          s1 = '<table' + this.getPopW() + this.getPopH() + ' style="border-style: solid; border-width: 2px;" bordercolor="' + this.bordercolor + '" cellpadding="' + this.bordercellpadding + '" cellspacing="' + this.bordercellspacing + '"  bgcolor="' + this.bgcolor + '"><tr><td>'
